...
export const MacWindowCard = () => {
  ...
  return (
    <Card className="relative lg:w-[900px] lg:h-[525px] 2xl:w-[1200px] 2xl:h-[700px] hidden lg:block bg-black rounded-3xl overflow-hidden shadow-[0_0_15px_rgba(255,105,180,0.5)] lg:right-[-10%] 2xl:right-[-20%] transform transition-transform duration-300 hover:translate-y-[-5px]">
      <CardHeader
        className={`flex justify-between p-2 ${topBarColor} border-b border-gray-700`}
      >
